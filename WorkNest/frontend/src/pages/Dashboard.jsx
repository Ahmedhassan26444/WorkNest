      ...
      <aside className="hidden lg:flex w-72 bg-slate-900 border-r border-slate-800 flex-col">
        ...
        <div className="p-5 border-t border-slate-800">
          <div className="flex items-center gap-3 p-3 rounded-xl bg-slate-800/60">
            <div className="w-10 h-10 rounded-full bg-blue-600 overflow-hidden flex items-center justify-center font-bold">
              {profilePhoto ? (
                <img
              ...
              {profileOpen && (
                <div className="absolute right-0 top-full mt-3 w-64 bg-slate-900 border border-slate-800 rounded-2xl shadow-2xl overflow-hidden z-50">
                  ...
                  <div className="p-4 border-b border-slate-800">
                    <div className="flex items-center gap-3">
                      <div className="w-11 h-11 rounded-full bg-blue-600 overflow-hidden flex items-center justify-center font-bold">
                        {profilePhoto ? (
                          <img
                            src={`http://localhost:5000${profilePhoto}`}
                            alt={userName}
        ...
        <section className="p-5 md:p-8 xl:p-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5 mb-8">
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 hover:border-slate-700 transition">
              ...
              <h3 className="text-3xl font-bold mt-2">{teamMembers}</h3>

              <p className="text-xs text-slate-500 mt-2">Workspace members</p>
            </div>
            ...
            <div className="xl:col-span-2 bg-slate-900 border border-slate-800 rounded-2xl p-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8 pt-6 border-t border-slate-800">
                ...
                <div>
                  ...
                  <p className="text-xl font-bold mt-1">{activeProjects}</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-xl font-bold mt-1">{remainingTasks}</p>
                </div>
              </div>
            </div>
              ...
              <div className="mt-8">
                ...
                <div className="space-y-4 mt-8">
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-slate-800">
                    ...
                    <span className="text-sm font-semibold">{teamMembers}</span>
                  </div>
                </div>
              </div>
            </div>
